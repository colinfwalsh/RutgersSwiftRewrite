...
class RouteCollectionViewDataSource: NSObject, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    let routeColors = [UIColor(red:1.00, green:0.00, blue:1.00, alpha:1.0), UIColor(red:1.00, green:0.80, blue:0.60, alpha:1.0), UIColor(red:0.00, green:1.00, blue:1.00, alpha:1.0), UIColor(red:0.60, green:0.20, blue:0.40, alpha:1.0), UIColor(red:0.40, green:0.60, blue:1.00, alpha:1.0), UIColor(red:1.00, green:0.00, blue:0.00, alpha:1.0), UIColor(red:0.00, green:0.50, blue:0.50, alpha:1.0), UIColor(red:0.40, green:0.40, blue:0.60, alpha:1.0)]
